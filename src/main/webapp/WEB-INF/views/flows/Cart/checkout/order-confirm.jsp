    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="${contextRoot}/home">Online Pizza Delivery</a>
           </div>
		</div>
	</nav>
	...
	<div class="content">
		<div class="container">
		    ...
		    <div class="text-center">
		    	<a href="${contextRoot}/show/all/products" class="btn btn-lg btn-warning">Continue Ordering</a>
		    </div>
		</div>
