...
public class CartController {
	...
	public ModelAndView showCart(@RequestParam(name = "result", required=false)String result) {
		...
		if(result!=null) {
			switch(result) {
			case "updated":
					mv.addObject("message", "Product has been updated successfully!");
					break;
			case "added":
				mv.addObject("message", "Product has been added successfully!");
				break;
			case "deleted":
				mv.addObject("message", "Product has been removed successfully!");
				break;					
			case "maximum":
				mv.addObject("message", "Product has reached to maximum count!");
				break;					
			case "unavailable":
